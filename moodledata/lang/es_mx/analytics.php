...
$string['nocourses'] = 'Sin asignatura para analizar';
...
$string['percentonline_help'] = 'Si su institución ofrece asignaturas mezcladas (blended) o híbridas, ¿qué porcentaje del trabajo del estudiante es realizado en línea en Moodle? Ingrese un número entre 0 y 100.';
...
$string['timesplittingmethod_help'] = 'El intervalo de análisis define cuando el sistema calculará predicciones y la porción de las bitácoras de actividad que serán consideradas para esas  predicciones. Por ejemplo, la duración de la asignatura puede ser dividida en partes, con una  predicción generada al final de cada parte.';
