...
$string['allowcoursethemes'] = 'Permitir temas en la asignatura';
...
$string['backup_shortname'] = 'Usar nombre de la asignatura en el nombre del archivo de copia de seguridad';
$string['backup_shortnamehelp'] = 'Usar el nombre de la asignatura como parte del nombre del archivo de copia de seguridad (en vez de usar el ID de la asignatura).';
...
$string['calendartype_desc'] = 'Elija un tipo de calendario por defecto para todo el sitio. Esta configuración no puede anularse en las configuraciones de la asignatura, ni por usuarios en su perfil personal.';
...
$string['configallowcategorythemes'] = 'Si activa esta opción, los temas pueden ajustarse al nivel de la categoría. Esto afectará a todas las categorías y asignaturas de nivel inferior (\'hijos\') a menos que tengan especificado su propio tema. ADVERTENCIA: Habilitar esta opción puede afectar al rendimiento.';
...
$string['configallowcoursethemes'] = 'Si se habilita, entonces se permitirá a las asignaturas configurar sus propios temas. Los temas de las asignaturas pasan por alto cualesquiera otras opciones de tema (sitio, usuario, categoría, cohorte tema definido por la URL).';
...
$string['configallowuserthemes'] = 'Si se activa esta opción, los usuarios podrán elegir sus propios temas. Los temas personales de los usuarios anulan los temas del sitio (pero no los temas de la asignatura)';
...
$string['configallusersaresitestudents'] = 'En lo que concierne a las actividades de la portada del sitio, ¿deberían TODOS los usuarios ser considerados como estudiantes? Si la respuesta es "Sí", cualquier usuario con cuenta confirmada podrá participar como estudiante en tales actividades. Si la respuesta es "No", sólo los usuarios que ya participan en al menos una asignatura podrán tomar parte en las actividades de la página principal. Sólo los administradores y profesores especialmente asignados pueden actuar como profesores en las actividades de la portada.';
...
$string['configautologinguests'] = '¿Deberá permitirse a los visitantes automáticamente el acceso como invitados cuando entran a las asignaturas con acceso de invitado?';
...
$string['configcoursegraceperiodafter'] = 'Clasificar asignaturas pasadas como en progreso por este número de días después de la fecha de fin de la asignatura.';
$string['configcoursegraceperiodbefore'] = 'Clasificar asignaturas futuras como en progreso por este número de días antes de la fecha de inicio de la asignatura.';
$string['configcourseoverviewfilesext'] = 'Lista separada por comas de extensiones permitidas para los archivos de imagen de la asignatura';
$string['configcourseoverviewfileslimit'] = 'El número máximo de archivos que pueden ser mostrados junto al resumen de la asignatura en la página de lista de asignaturas. El primer archivo de imagen añadido es usado como la imagen de la asignatura en la vista general de la asignatura en los Tableros de los usuarios: los archivos adicionales son mostrados solamente en la página de la lista de asignaturas.';
$string['configcourserequestnotify'] = 'Escriba el nombre de usuario a quien se enviará una notificación cuando se solicite una nueva asignatura';
$string['configcourserequestnotify2'] = 'Usuarios a quienes se notificará cuando una nueva asignatura sea solicitada. En esta lista figuran únicamente los usuarios que pueden aprobar las solicitudes de asignatura.';
$string['configcoursesperpage'] = 'Introduzca el número de asignaturas a ser mostradas por página en un listado de asignaturas.';
$string['configcourseswithsummarieslimit'] = 'El número máximo de asignaturas a mostrar en un listado de asignaturas, incluyendo resúmenes, antes de revertir a un listado más simple.';
...
<pre>
Asignaturas
-Todos las asignaturas|/course/
-Buscar asignatura|/course/search.php
-###
...
$string['configdefaultrequestcategory'] = 'Las asignaturas solicitadas por los usuarios con la capacidad para solicitar asignaturas nuevas en el contexto del sistema serán puestos en esta categoría a menos que los usuarios puedan seleccionar una categoría diferente.';
$string['configdefaultrequestedcategory'] = 'Categoría por defecto en la que incluir las asignaturas solicitadas, en el caso de que sean aprobadas.';
$string['configdefaultuserroleid'] = 'A todos los usuarios autenticados se les asignarán las capacidades del rol que usted especifique aquí, en el nivel del sitio, ADEMÁS de cualesquiera otros roles que puedan tener. El rol por defecto es el de Usuario Autenticado (Authenticated user). Advierta que esto no entrará en conflicto con otros roles que el usuario tenga a menos que Usted prohiba capacidades (prohibit capabilities). Simplemente asegura que todos los usuarios tengan capacidades que no son asignables a nivel de asignatura (por ejemplo: enviar entradas al blog, gestionar su propio calendario, etc.).';
...
$string['configdndallowtextandlinks'] = 'Activar o desactivar la función "Arrastrar y Soltar" texto y enlaces a una página de la asignatura, junto con el arrastrar y soltar los archivos. Tenga en cuenta que el arrastre de texto en Firefox, o entre diferentes navegadores no siempre es confiable y puede dar lugar a que no se suba nada, o que suba texto corrupto.
...
$string['configenablestats'] = 'Si selecciona \'sí\', el cronjob de Moodle procesará las bitácoras y recopilará algunas estadísticas. Dependiendo de la cantidad de tráfico del sitio, esta operación puede demorarse. Si activa esta opción, podrá ver algunos gráficos y estadísticas interesantes sobre cada una de sus asignaturas, o bien sobre todo el sitio.';
...
$string['configforcelogin'] = 'Normalmente la portada del sitio y las listas de las asignaturas (pero no las asignaturas) pueden ser leídos por cualquiera sin necesidad de escribir su nombre de usuario y contraseña. Si desea forzar a los visitantes a acceder al sitio antes de poder ver CUALQUIER CONTENIDO, debería activar esta opción.';
...
$string['configfrontpagecourselimit'] = 'Número máximo de asignaturas';
$string['configfrontpagecourselimithelp'] = 'Número máximo de asignaturas a mostrarse en la portada del sitio en los listados de asignaturas.';
...
$string['configgradebookroles'] = 'Esta configuración le permite controlar quien aparece en el libro de calificaciones. Los usuarios necesitan tener al menos uno de estos roles en una asignatura para poder aparecer en el libro de calificaciones de la asignatura. Es muy importante que esté activada la casilla de estudiante o no les podrán calificar sus tareas y exámenes..';
...
$string['confighiddenuserfields'] = 'Para aumentar la privacidad de los estudiantes, seleccione qué campos de información sobre el usuario desea ocultar a otros usuarios distintos de los profesores de la asignatura o los administradores (mánagers). Mantenga pulsada la tecla CTRL para seleccionar varios campos.
...
$string['configlockrequestcategory'] = 'Si se habilita, los usuarios con la capacidad para solicitar nuevas asignaturas en el contexto del sistema no podrán seleccionar una categoría en  el formato para solicitar una nueva asignatura. Una manera alternativa para restringir a los usuarios para que soliciten una nueva asignatura en solamente una categoría, es aplicar la capacidad para solicitar asignaturas nuevas en el contexto de categoría.';
...
$string['configmaxusersperpage'] = 'Número máximo de usuarios mostrados dentro del selector de usuarios en asignatura, grupo, cohorte, servicio web, etc.';
...
$string['configmycoursesperpage'] = 'Número máximo de asignaturas que se mostrará en cualquier lista de asignaturas propias de un usuario';
...
$string['confignavcourselimit'] = 'Limita el número de asignaturas mostradas al usuario en la navegación.';
$string['confignavshowallcourses'] = 'Esta configuración determina si es que los usuarios que están inscritos en asignaturas pueden ver Asignaturas (listado de todos las asignaturas) en la navegación, adicionalmente a Mis Asignaturas (listado de las asignaturas en donde ellos están inscritos).';
$string['confignavshowcategories'] = 'Mostrar las categorías de asignatura en la barra de navegación y en los bloques de navegación. Esto no ocurre con asignaturas en las que el usuario está actualmente inscrito, de manera que todavía aparecerán bajo Mis asignaturas sin categorías.';
...
$string['configprofilesforenrolledusersonly'] = 'Para prevenir el abuso de los creadores de spam, se ocultan las descripciones del perfil de los usuarios que aún no están inscritos en ninguna asignaturas. Los usuarios nuevos deben inscribirse en al menos una asignatura antes de que puedan agregar la descripción del perfil.';
...
$string['configrequestcategoryselection'] = 'Permitir la selección de una categoría al solicitar una asignatura';
$string['configrequestedstudentname'] = 'Término utilizado para \'estudiante\' en las asignaturas solicitadas';
$string['configrequestedstudentsname'] = 'Término utilizado para \'estudiantes\' en las asignaturas solicitadas';
$string['configrequestedteachername'] = 'Término utilizado para \'profesor\' en las asignaturas solicitadas';
$string['configrequestedteachersname'] = 'Término utilizado para \'profesores\' en las asignaturas solicitadas';
...
$string['configsectionrequestedcourse'] = 'Solicitudes de asignaturas';
...
$string['configstatsuserthreshold'] = 'Este ajuste especifica el número mínimo de usuarios inscritos en una asignatura para que este valor sea incluido en los cálculos de las estadísticas.';
...
$string['configuseblogassociations'] = '¿Deberían los usuarios poder organizar su blog asociando entradas con las asignaturas y con los módulos de asignatura?';
...
$string['configvisiblecourses'] = 'Mostrar normalmente las asignaturas de categorías ocultas';
...
$string['contextlocking_desc'] = 'Esta configuración le permite configurar acceso de solo lectura para  categorías, asignaturas, actividades y bloques seleccionados.';
$string['cookiehttponly'] = 'Sólo \'cookies\' http';
$string['cookiesecure'] = 'Sólo \'cookies\' seguras';
$string['country'] = 'País por defecto';
$string['course_customfield'] = 'Campos personalizados de la asignatura';
$string['coursecolor'] = 'Color {$a}';
$string['coursecolorheading_desc'] = 'Cualquier asignatura sin una imagen configurada en las configuraciones de la asignatura será mostrada en el Tablero con una tarjeta de asignatura con un patrón de colores. Los colores usados en el patrón pueden ser especificados debajo.';
$string['coursecolorsettings'] = 'Colores de tarjeta de la asignatura';
$string['coursecontact'] = 'Responsables (contactos) de la asignatura';
$string['coursecontact_desc'] = 'Esta opción le permite controlar quién aparece en la descripción de la asignatura. Los usuarios deben tener al menos uno de estos roles en una asignatura a fin de poder mostrarlos en la descripción de esa asignatura.';
$string['coursecontactduplicates'] = 'Mostrar todos los roles de contacto de la asignatura';
$string['coursecontactduplicates_desc'] = 'Si se habilita, los usuarios con más de uno de los roles de contacto de la asignatura serán mostrados en la descripción de la asignatura con cada uno de los roles. De lo contrario, ellos serán mostrados con solamente un rol (el que esté  enlistado más alto en \'Definir roles\' en la Administración del sitio).';
$string['coursegraceperiodafter'] = 'Período de gracia para asignaturas pasadas';
$string['coursegraceperiodbefore'] = 'Período de gracia para asignaturas futuras';
$string['courselistshortnames'] = 'Mostrar nombres extendidos de asignaturas';
$string['courselistshortnames_desc'] = 'Si se habilita, se mostrarán tanto el nombre corto de la asignatura como el nombre completo en las listas de asignaturas. Si se requiere, los nombres extendidos de la asignatura pueden personalizarse al editar  la cadena de texto de idioma \'courseextendednamedisplay\' , mediante la personalización del idioma.';
$string['coursemgmt'] = 'Gestionar asignaturas y categorías';
$string['courseoverview'] = 'Vista general de la asignatura';
$string['courserequestnotify'] = 'Notificación de solicitud de asignatura';
$string['courserequestnotifyemail'] = 'El usuario {$a->user} ha solicitado una nueva asignatura en {$a->link}';
$string['courserequests'] = 'Solicitudes de asignaturas';
$string['courserequestspending'] = 'Solicitudes de asignatura pendientes';
$string['courses'] = 'Asignaturas';
$string['coursesperpage'] = 'Asignaturas por página';
$string['courseswithsummarieslimit'] = 'Límite de asignaturas con resúmenes';
$string['creatornewroleid'] = 'Rol de los creadores en asignaturas nuevas';
$string['creatornewroleid_help'] = 'Si el usuario no tiene aún permiso para administrar las nueva asignatura, el usuario es inscrito automáticamente utilizando este rol.';
$string['cron'] = 'Cron';
...
$string['defaultformatnotset'] = 'Error al determinar el formato por defecto de la asignatura. Por favor revise las configuraciones del sitio.';
$string['defaulthomepage'] = 'Página de inicio para los usuarios';
$string['defaultrequestcategory'] = 'Categoría por defecto de las solicitudes de asignatura';
...
$string['downloadcoursecontentallowed'] = 'Característica de Descargar contenido de la asignatura disponible';
$string['downloadcoursecontentallowed_desc'] = 'Si es que la característica para descargar contenido de la asignatura está disponible a asignaturas. Cuando está disponible, las descargas de contenidos de la asignatura pueden ser habilitadas/deshabilitadas usando la configuración para "Habilitar descargar contenido de la asignatura" dentro del menú para editar la asignatura (lo predeterminado para esto puede ser configurado en <a href={$a} target="_blank">Configuraciones predeterminadas de ña asignatura</a>).';
...
$string['enablecourserelativedates'] = 'Habilitar fechas relativas de asignatura';
$string['enablecourserelativedates_desc'] = 'Permitir que las asignaturas sean configuradas para mostrar fechas relativas a la fecha de inicio del usuario en la asignatura.';
$string['enablecourserequests'] = 'Habilitar solicitudes de asignatura';
...
$string['enrolinstancedefaults_desc'] = 'Ajustes predeterminados de inscripción en nuevas asignaturas.';
...
$string['filescleanupperiod_help'] = 'Que tan frecuentemente son eliminados los archivos basura. Estos son archivos que están asociados con un contenido que ya no existe; por ejemplo, cuando una asignatura es eliminada. Por favor tenga en cuenta que esta configuración puede resultar en archivos faltantes en una asignatura que sea respaldada, eliminada y después restaurada si la configuración para  \'Incluir archivos\' (backup_auto_files) estuviera deshabilitada en \'Configuraciones de respaldo automatizado\'.';
$string['filesizeunits'] = 'unidades tamaño de la asignatura';
...
$string['formatuninstallwithcourses'] = 'Hay {$a->count} asignaturas que usan {$a->format}. Sus formatos serán cambiados a {$a->defaultformat} (el formato por defecto para este sitio). Algunos datos específicos de este formato se pueden perder. ¿Está Usted seguro de querer hacerlo?';
...
$string['guestroleid_help'] = 'Este rol se le asigna automáticamente a los invitados. También se asigna, temporalmente, por medio del plugin de inscripción de invitados a los usuarios que no están inscritos en una asignatura.';
$string['h5pgetcontenttypestask'] = 'Descargar tipos de contenido H5P disponibles de h5p.org';
$string['helpadminseesall'] = 'En el calendario del sitio, ¿ pueden los administradores ver y filtrar eventos de todos los calendarios de asignaturas o solamente los de las asignaturas en las cuales están inscritos ? Sin importar la opción elegida, los administradores siempre podrán gestionar eventos para cada calendario de asignatura al navegar primeramente a la asignatura, y después acceder directamente al calendario de la asignatura.';
...
$string['legacyfilesaddallowed'] = 'Permitir añadir a los archivos heredados de la asignatura';
$string['legacyfilesaddallowed_help'] = 'Si una asignatura tiene archivos heredados, permite que los nuevos archivos y carpetas se le añadan.';
$string['legacyfilesinnewcourses'] = 'Archivos heredados en las asignaturas nuevas';
$string['legacyfilesinnewcourses_help'] = 'De forma predeterminada, los archivos heredados sólo están disponibles en las asignaturas actualizadas desde versiones anteriores de Moodle (1.9.x a 2.0 por ejemplo). Por favor tenga en cuenta que algunas características como respaldo y restauración de actividades individuales no son compatibles con esta configuración.';
...
$string['linkcoursesections'] = 'Siempre ligar secciones de asignatura';
$string['linkcoursesections_help'] = 'Tratar siempre de proporcionar un enlace para secciones de asignatura. Las secciones de asignatura generalmente solo son mostradas como enlaces si el formato de la asignatura muestra solamente una sección por página. Si se habilita esta configuración, siempre se proporcionará un enlace.';
...
$string['maintinprogress'] = 'Mantenimiento en asignatura...';
...
$string['managecustomfields'] = 'Gestionar campos personalizados de la asignatura';
$string['manageformats'] = 'Gestionar formatos de asignatura';
...
$string['maxsizeperdownloadcoursefile_desc'] = 'El tamaño máximo de cada archivo al descargar contenido de la asignatura.Los archivos que excedan este tamaño serán omitidos de la descarga.';
...
$string['mnetrestore_extusers_noadmin'] = '<strong> Nota: </strong> Este archivo de respaldo parece venir de otra instalación de Moodle y contiene cuentas de usuario de Moodle Network. No tiene permiso para ejecutar este tipo de restauración. Póngase en contacto con el administrador del sitio o bien, restaure esta asignatura sin ningún tipo de información de usuario (módulos, archivos ...)';
...
$string['moodleapp_help'] = '<p>La App Moodle gratuita le permite a los usuarios acceder a sus asignaturas en dispositivos móviles. Características adicionales de la App están disponibles con un plan App Pro o Premium.</p>
...
$string['mycoursesperpage'] = 'Número de asignaturas';
...
$string['navadduserpostslinks_help'] = 'Si está habilitado, dos enlaces se añadirán a la navegación del usuario  para ver las discusiones que el usuario ha comenzado y los mensajes que el usuario ha hecho en foros en todo el sitio o en asignaturas específicas.';
$string['navcourselimit'] = 'Límite de la asignatura';
$string['navigationupgrade'] = 'Esta actualización introduce dos nuevos bloques de navegación que sustituirán a estos bloques: Administración, Asignaturas, Actividades y Participantes. Si tiene establecido algún permiso especial en estos  bloques debe asegurarse de que todo se está comportando como usted desea.';
$string['navshowallcourses'] = 'Mostrar todos las asignaturas';
$string['navshowcategories'] = 'Mostrar las categorías de lss asignaturas';
...
$string['navshowfullcoursenames'] = 'Mostrar nombres completos de asignaturas';
$string['navshowfullcoursenames_help'] = 'Si se habilita, los nombres completos de las asignaturas serán usados en la navegación en lugar de los nombres cortos.';
$string['navshowmycoursecategories'] = 'Mostrar categorías de mis asignaturas';
$string['navshowmycoursecategories_help'] = 'Si se habilita, las asignaturas en la rama de Mis asignaturas del usuario serán mostrados en categorías en el bloque de Navegación (solamente temas basados en Classic).';
$string['navsortmycourseshiddenlast'] = 'Ordenar mis asignaturas ocultas al final';
$string['navsortmycourseshiddenlast_help'] = 'Si se habilita, cualquier asignatura oculta será enlistada después de las asignaturas visibles (para usuarios que puedan ver asignaturas ocultas). En caso contrario, todas las asignaturas, sin importar su visibilidad, serán enlistados de acuerdo a la configuración para \'Ordenar mis asignaturas\'.';
$string['navsortmycoursessort'] = 'Ordenar mis asignaturas';
$string['navsortmycoursessort_help'] = 'Determina si se enlistan las asignaturas debajo de Mis asignaturas de acuerdo al orden (por ejemplo, en el órden elegido en Configuraciones > Administración del sitio > Asignaturas > Añadir/editar asignaturas)  o alfabéticamente por configuración de la asignatura.';
$string['never'] = 'Nunca';
...
* Visible a usuarios, profesores y admins - Para datos privados solamente visibles por el usuario, administradores y profesores (en perfil de la asignatura)
* Visible para todos';
...
$string['restorecourse'] = 'Restaurar asignatura';
$string['restorernewroleid'] = 'Rol de los restauradores en las asignaturas';
$string['restorernewroleid_help'] = 'Si el usuario no tiene todavía permiso para administrar la asignatura recién restaurada, se le asigna este permiso automáticamente y se le da de alta en caso necesario. Seleccione "Ninguno(a)" si no quiere que los restauradores puedan gestionar todas las asignaturas restauradas.';
...
$string['searchablecourses'] = 'Asignaturas en las que se puede buscar';
$string['searchallavailablecourses'] = 'Asignaturas en las que se puede buscar';
$string['searchallavailablecourses_desc'] = 'En algunas situaciones, el motor de búsqueda podría no funcionar cuando se busca adentro de un gran número de asignaturas. Configúrelo para buscar solamente en asignaturas inscritas si Usted necesita restringir el número de asignaturas buscadas.';
$string['searchallavailablecourses_off'] = 'Buscar solamente dentro de asignaturas inscritas';
$string['searchallavailablecourses_on'] = 'Buscar dentro de todas las asignaturas a las que el usuario puede acceder';
$string['searchallavailablecoursesdesc'] = 'Si se configura a buscar solamente dentro  de asignaturas inscritas, la información de la asignatura (nombre y resumen) y el contenido de la asignatura solamente será buscada en las asignaturas en las cuales el usuario está inscrito. De otra forma, la información de la asignatura y el contenido de la asignatura será buscada en todas las asignaturas a los cuales el usuario puede acceder, como por ejemplo las asignaturas con acceso de invitados habilitado.';
...
$string['searchincludeallcourses'] = 'Incluir todas las asignaturas visibles';
$string['searchincludeallcourses_desc'] = 'Si se habilita, los resultados de la búsqueda incluirán información de la asignatura (nombre y resumen) de asignaturas que sean visibles para el usuario, aunque no tenga acceso al contenido de la asignatura.';
...
$string['sort_fullname'] = 'Nombre completo dela asignatura';
$string['sort_idnumber'] = 'Número de ID dela asignatura';
$string['sort_shortname'] = 'Nombre corto dela asignatura';
...
$string['stickyblockscourseview'] = 'Página de la asignatura';
