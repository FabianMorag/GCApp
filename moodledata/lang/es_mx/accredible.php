...
$string['additionalactivitiesone'] = 'Advertencia: Se está agregando más de una actividad a una asignatura. <br/>Ambas actividades están visibles para los estudiantes, asegúrese de darles diferentes nombres.';
...
$string['completionissuecheckbox'] = 'Si, emitir al finalizar la asignatura';
$string['completionissueheader'] = 'Criterio para auto-emisión: por finalización de la asignatura';
...
$string['passinggrade'] = 'Porcentaje de la calificación (%) necesario para pasar la asignatura';
