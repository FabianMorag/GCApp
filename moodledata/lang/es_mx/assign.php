...
$string['couldnotcreatecoursemodule'] = 'No pudo crearse módulo de asignatura';
...
$string['fixrescalednullgrades'] = 'Esta tarea contiene algunas calificaciones erróneas. Usted puede <a href="{$a->link}">corregir automáticamente estas calificaciones</a>. Esto podría afectar los totales de la asignatura.';
$string['fixrescalednullgradesconfirm'] = '¿ Está seguro de querer corregir calificaciones erróneas ? Todas las calificaciones afectadas serán eliminadas. Esto podría afectar los totales de la asignatura.';
...
$string['maxperpage_help'] = 'El número máximo de Tareas que un evaluador puede mostrar en la página para calificar tareas. Es útil para prevenir des-conexiones por tiempo excesivo en asignaturas con muchos participantes.';
...
$string['relativedatessubmissionduedateafter'] = '{$a->datediffstr} después del inicio de la asignatura';
$string['relativedatessubmissionduedatebefore'] = '{$a->datediffstr} antes del inicio de la asignatura';
