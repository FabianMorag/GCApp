...
$string['blocks_description_course_overview'] = 'El bloque de Vista general de la asignatura es visible en la página de Mi hogar del usuario y muestra una lista de todos los cursos en los que el usuario está inscrito o tiene un rol asignado.';
