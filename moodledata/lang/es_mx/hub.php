...
$string['sendfollowinginfo_help'] = 'La siguiente información será enviada a Moodle cada vez que sea actualizado el registro de su sitio (de forma predeterminada cada semana, cuando el trabajo agendado de \'Registro del sitio\' sea ejecutado). Esta información contribuye a las estadísticas globales solamente y no será hecho pública en ningún listado del sitio.';
